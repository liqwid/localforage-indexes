...
import { _upgradeStore, _getIndex } from './utils';
 ...
 * @return {Promise} resolves with new index, rejects if index is present
*/
 ...
 * Gets index
 * @param {String} indexName
 * @return {Promise} resolves with an index, rejects if index is not found
*/
 ...
 * @param {String} keyPath, indexDb key path, keys separated with dot
 * @param {Object} options, indexDb index creation options
 * @return {Promise} resolves with updated index, rejects if index is present
*/
